...
def iond():
        if version == "14.04" and mem >= 4:
                urllib.urlretrieve ("https://raw.githubusercontent.com/sk00t3r/ubuntu-iond3/master/ubuntu14.sh", "ubuntu14.sh")
                os.chmod('ubuntu14.sh', 0755)
                subprocess.call("./ubuntu14.sh", shell=True)
                
        elif version == "14.04":
                urllib.urlretrieve ("https://raw.githubusercontent.com/sk00t3r/ubuntu-iond3/master/ubuntu14_lowram.sh", "ubuntu14_lowram.sh")
                os.chmod('ubuntu14_lowram.sh', 0755)
                subprocess.call("./ubuntu14_lowram.sh", shell=True)
